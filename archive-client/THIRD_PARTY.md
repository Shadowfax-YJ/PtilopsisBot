...
OpenList and rclone run as separate local processes. Their release archives are checked against upstream SHA-256 release digests/manifests by `scripts/vendor.cjs`. Runtime npm dependencies and their license files remain in the application archive. No account credentials are included in the distribution.
